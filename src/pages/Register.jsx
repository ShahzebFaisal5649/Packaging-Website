...
function PasswordStrengthBar({ password }) {
  ...
  return (
    <div style={{ marginTop: 8 }}>
      <div style={{ height: 4, width: '100%', backgroundColor: '#E0DBD3', borderRadius: 2, overflow: 'hidden', marginBottom: 4 }}>
...
export default function Register() {
  ...
  const handleChange = (e) => {
    ...
    if (!strength || strength.label === 'Too short' || strength.label === 'Weak') {
      return showToast('Password is too weak. Add uppercase, numbers, and at least 8 characters.', 'error');
    }
  ...
  return (
    <div style={{ minHeight: 'calc(100vh - (var(--nav-h) + var(--ann-h)))', display: 'grid', gridTemplateColumns: '1fr 1fr' }} className="auth-grid">
      ...
      {/* Right — form */}
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '60px 24px', backgroundColor: '#F5F2ED', overflowY: 'auto', overflowX: 'hidden', boxSizing: 'border-box', width: '100%' }}>
        <div style={{ width: '100%', maxWidth: 440, boxSizing: 'border-box' }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
            ...
            <Button
              ...
              style={{ padding: '14px', borderRadius: 10, marginTop: 4 }}
              icon={ArrowRight}
            >
